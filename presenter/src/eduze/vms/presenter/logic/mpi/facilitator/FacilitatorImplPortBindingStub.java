/**
 * FacilitatorImplPortBindingStub.java
 *
...
public class FacilitatorImplPortBindingStub extends org.apache.axis.client.Stub implements eduze.vms.presenter.logic.mpi.facilitator.Facilitator {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("requestConnection");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "PresenterName"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "PassKey"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("checkConnectionRequestState");
    ...
    public FacilitatorImplPortBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public FacilitatorImplPortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public FacilitatorImplPortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public java.lang.String requestConnection(java.lang.String presenterName, java.lang.String passKey) throws java.rmi.RemoteException, eduze.vms.presenter.logic.mpi.facilitator.InvalidFacilitatorPasskeyException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://webservices.logic.facilitator.vms.eduze/", "requestConnection"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {presenterName, passKey});
  ...
  throw axisFaultException;
    ...
    public eduze.vms.presenter.logic.mpi.facilitator.ConnectionRequestState checkConnectionRequestState(java.lang.String connectionRequestId) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://webservices.logic.facilitator.vms.eduze/", "checkConnectionRequestState"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {connectionRequestId});
  ...
  throw axisFaultException;
    ...
    public java.lang.String getFacilitatorName() throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://webservices.logic.facilitator.vms.eduze/", "getFacilitatorName"));
