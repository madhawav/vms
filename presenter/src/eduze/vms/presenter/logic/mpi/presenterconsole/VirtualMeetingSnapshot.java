...
public class VirtualMeetingSnapshot  implements java.io.Serializable {
    ...
    private eduze.vms.presenter.logic.mpi.presenterconsole.SessionStatus status;
    ...
    public VirtualMeetingSnapshot(
           ...
           eduze.vms.presenter.logic.mpi.presenterconsole.SessionStatus status) {
           this.VMId = VMId;
     ...
     * @return status
     */
    public eduze.vms.presenter.logic.mpi.presenterconsole.SessionStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(eduze.vms.presenter.logic.mpi.presenterconsole.SessionStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.logic.facilitator.vms.eduze/", "VirtualMeetingSnapshot"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.logic.facilitator.vms.eduze/", "sessionStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
